...
The charts demo's scenarios page after the spec's table (one screen per world listed there), each titled by the user's job, with callouts and Built from. Former demonstrations of this demo go into it.
