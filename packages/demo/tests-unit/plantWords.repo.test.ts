...
const PENDING: readonly string[] = [
  ...
  "packages/charts/demo/data.ts",
  "packages/charts/demo/examples/Area/01-filled.tsx",
  "packages/charts/demo/examples/Area/02-corridor.tsx",
  "packages/charts/demo/examples/Area/03-stacked.tsx",
  "packages/charts/demo/examples/Axis/01-configuration.tsx",
  "packages/charts/demo/examples/Axis/02-axes.tsx",
  "packages/charts/demo/examples/Axis/03-working-time.tsx",
  "packages/charts/demo/examples/Axis/04-time.tsx",
  "packages/charts/demo/examples/Axis/05-zoom-and-pan.tsx",
  "packages/charts/demo/examples/Axis/06-visible-domain.tsx",
  "packages/charts/demo/examples/Axis/07-aligned-ticks.tsx",
  "packages/charts/demo/examples/Bar/01-per-shift.tsx",
  "packages/charts/demo/examples/Bar/02-grouped.tsx",
  "packages/charts/demo/examples/Bar/03-deviation.tsx",
  "packages/charts/demo/examples/Bar/04-stacked.tsx",
  "packages/charts/demo/examples/Bar/05-percent.tsx",
  "packages/charts/demo/examples/Benchmark/01-benchmark.tsx",
  "packages/charts/demo/examples/Benchmark/02-a-week-of-seconds.tsx",
  "packages/charts/demo/examples/Chart/01-mixed.tsx",
  "packages/charts/demo/examples/Chart/02-sizes.tsx",
  "packages/charts/demo/examples/Chart/03-empty.tsx",
  "packages/charts/demo/examples/Chart/04-cursor-sync.tsx",
  "packages/charts/demo/examples/Chart/05-keyboard-and-screen-reader.tsx",
  "packages/charts/demo/examples/Chart/06-told-apart-without-colour.tsx",
  "packages/charts/demo/examples/Chart/07-marks-on-every-kind.tsx",
  "packages/charts/demo/examples/Chart/08-bands-limits-and-cells.tsx",
  "packages/charts/demo/examples/ControlChart/01-control-chart.tsx",
  "packages/charts/demo/examples/LimitLine/01-limits-and-state.tsx",
  "packages/charts/demo/examples/Line/01-basic.tsx",
  "packages/charts/demo/examples/Line/02-multi-series.tsx",
  "packages/charts/demo/examples/Line/03-step.tsx",
  "packages/charts/demo/examples/Matrix/01-matrix.tsx",
  "packages/charts/demo/examples/Pareto/01-pareto.tsx",
  "packages/charts/demo/examples/Scatter/01-measurements.tsx",
  "packages/charts/demo/examples/Scatter/02-over-a-course.tsx",
  "packages/charts/demo/examples/StateBand/01-shift.tsx",
  "packages/charts/demo/examples/StateBand/02-under-a-course.tsx",
  "packages/charts/demo/examples/Tooltip/01-x-or-nearest.tsx",
  "packages/charts/demo/examples/Tooltip/02-own-content.tsx",
  "packages/charts/demo/examples/Tooltip/03-legend-placement.tsx",
  "packages/charts/demo/examples/Tooltip/04-value-format.tsx",
  "packages/charts/demo/examples/Tooltip/05-toggling-legend.tsx",
  "packages/charts/demo/examples/Tooltip/06-data-table.tsx",
  "packages/charts/demo/examples/Tooltip/07-a-week-as-a-table.tsx",
  "packages/charts/demo/outline.ts",
  "packages/charts/src/Line.tsx",
  "packages/charts/src/scene.ts",
  "packages/core/demo/examples.ts",
  ...
  "packages/core/demo/examples/Control-room/01-one-minute-three-places.tsx",
  ...
  "packages/core/demo/plant.ts",
  "packages/core/demo/scenarios/05-watch-a-kiln-line.tsx",
  "packages/schedule/demo/data.ts",
  ...
  "packages/schedule/demo/scenarios/01-replan-the-day.tsx",
