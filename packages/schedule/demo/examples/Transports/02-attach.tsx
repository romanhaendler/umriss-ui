...
import type { Subtask, Task, Transport, TransportAttachment } from "../../../src";

export const title = "Where a line touches its bars";

/* `attach` says where a transport's line begins and ends ON the bars: the
   ...
   Not to be confused with the two ANCHORS, which say what a transport
   connects and therefore whether it is late. This says only where the line
...
function Variant({ attach }: { attach: TransportAttachment }) {
  return (
    <Stack gap={1}>
