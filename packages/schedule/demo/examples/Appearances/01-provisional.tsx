...
/* `"provisional"` owns the FILL, and has none: the surface shows straight
   ...
   in this picture - a lead-in or a lead-out - and the released bar above carries
...
const WORK: Subtask[] = [
  { id: "released", task: "order", lane: "released", from: at(7), to: at(10), leadIn: min(30), leadOut: min(30) },
...
export default function Provisional() {
  return (
    <Schedule ariaLabel="Released work above, provisional work below" initialDomain={[at(6, 30), at(11)]} height={144}>
      <Lane id="released" label="Released, with lead-in" />
