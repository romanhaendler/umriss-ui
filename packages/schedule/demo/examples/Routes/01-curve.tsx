...
export const title = "Curve";

export const lead = "The default: each line leaves forwards and arrives forwards, so it shows which way the work goes, even when it loops back up.";
