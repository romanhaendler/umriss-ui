...
export const title = "Orthogonal";

export const lead = "`route=\"orthogonal\"` leaves the bar, runs across and comes in again, like a flow chart.";
...
export default function Orthogonal() {
  return (
    <Schedule ariaLabel="Search results, from layout to polish, orthogonal lines" initialDomain={[at(6, 30), at(13, 30)]} height={188} route="orthogonal" attach="nearest">
