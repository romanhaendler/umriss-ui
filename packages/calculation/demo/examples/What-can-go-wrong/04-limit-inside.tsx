...
/* The scrap on line 2 is beyond its alarm limit, two levels down in a folded
   line. The folded interim says so quietly - "Inside: Alarm limit exceeded" -
   without taking on the alarm's colour itself: its own number is not the one
   in alarm. Open it to find the line that is. */
    ...
    <Calculation aria-label="Scrap cost, hall 1">
      <Chain>
        <Product label="Scrap cost, line 1" unit="€" decimals={2}>
          ...
          <Given label="Material, line 1" value={24800} unit="€" />
        </Product>
        <Plus>
          <Product label="Scrap cost, line 2" unit="€" decimals={2}>
            ...
            <Given label="Material, line 2" value={19650} unit="€" />
          </Product>
        </Plus>
