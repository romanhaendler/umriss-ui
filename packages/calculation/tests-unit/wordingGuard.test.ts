/* Every text @umriss-ui/calculation shows comes from the wording of @umriss-ui/core
   (calculation 04) - the same guard as `packages/core/tests-unit/
...
describe("Sources of @umriss-ui/calculation", () => {
