/* The glyphs of @umriss-ui/calculation keep core's specification - one stroke
...
it("every glyph of @umriss-ui/calculation keeps one stroke width at the nominal size, in currentColor, without fill, hidden", () => {
