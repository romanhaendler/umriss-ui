...
export default defineConfig({
  plugins: [react(), ownStyles(), dts({ include: ["src"], rollupTypes: true, tsconfigPath: "./tsconfig.build.json" }), importOwnCss("calculation.js", "calculation.css")],
  build: {
    lib: {
      entry: "src/index.ts",
      formats: ["es"],
    ...
    rollupOptions: {
      ...
      output: { assetFileNames: "calculation.[ext]" },
    },
  },
});
