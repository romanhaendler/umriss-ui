/* Every text @umriss-ui/table shows comes from the wording of @umriss-ui/core
   (umriss-table 04) - the same guard as `packages/core/tests-unit/
   wortlautQuelle.test.ts`, over the sources of this package. Reading goes
...
describe("Sources of @umriss-ui/table", () => {
