...
- **`pageOfPages` groups its numbers as the language writes them**: "Page 1
  of 100,000", "Seite 1 von 100.000" - a table over a server has that many
  pages. Below a thousand pages nothing changes.
