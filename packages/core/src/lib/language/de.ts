...
export const GERMAN_WORDING: Wording = {
  ...
  columnForwardHint: "Nach vorn",
  columnBackwardHint: "Nach hinten",
  pinToStartHint: "Am Anfang fixieren",
  pinToEndHint: "Am Ende fixieren",
  unpinHint: "Fixierung lösen",
  exportLabel: "Exportieren",
  exportPageLabel: "Seite exportieren",
  ...
  scheduleViolatedDependency: "Abhängigkeit verletzt",
  scheduleGhostTimes: (from, to) => `${from}–${to}`,
  scheduleLeadIn: "Vorlauf",
  scheduleLeadOut: "Nachlauf",
  scheduleDependency: "Abhängigkeit",
