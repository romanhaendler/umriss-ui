...
|---|---|---|
| [`@umriss-ui/core`](packages/core/README.md) | 0.13.0 | The component library — forms, overlays, structure, the tree, the dock, the command palette. The package you install first |
...
| [`@umriss-ui/schedule`](packages/schedule/README.md) | 0.3.2 | The schedule: subtasks on lanes over time, with dependencies, blocked time, findings and controlled editing. Takes `@umriss-ui/core` and `@umriss-ui/charts` as peers |
