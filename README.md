...
| [`@umriss-ui/calculation`](packages/calculation/README.md) | 0.3.2 | A calculation a reader can follow and redo: a derivation written as it is shown, evaluated by the library. Takes `@umriss-ui/core` as a peer |
